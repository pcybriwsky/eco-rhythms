...
const myP5Sketch = (p) => {
    ...
    p.draw = () => {
        ...
        if (!isMagic) {
            ...
            p.textSize(20);
            // p.text("Timeline Version with: " + timeline.length + " records", 10, 7.25 * lineHeight);
    ...
    p.graphNebula = () => {
        ...
        p.text(currentObject.aqi.toFixed(2) + " ppm", p.width / 10 + 75, center + 80);
        ...
        p.text(dayObject.aqi.toFixed(2) + " ppm", p.width / 10 + 75, dayCenter + 80);
        ...
        p.text(allTimeObject.aqi.toFixed(2) + " ppm", p.width / 10 + 75, allTimeCenter + 80);
